    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        if($_SESSION['ration-bonne-rep'] == 1){
          echo "<h4 class=modal-title id=titrePopUp>Parfait !</h4>";
        }
        elseif($_SESSION['ration-bonne-rep'] >= 0.9){
          echo "<h4 class=modal-title id=titrePopUp>Magnifique !</h4>";
        }
        elseif($_SESSION['ration-bonne-rep'] >= 0.8){
          echo "<h4 class=modal-title id=titrePopUp>Super !</h4>";
        }
        elseif($_SESSION['ration-bonne-rep'] >= 0.6){
          echo "<h4 class=modal-title id=titrePopUp>Pas mal !</h4>";
        }
        elseif($_SESSION['ration-bonne-rep'] >= 0.45){
          echo "<h4 class=modal-title id=titrePopUp>T'es sur le bon chemin !</h4>";
        }
        elseif($_SESSION['ration-bonne-rep'] >= 0.2){
          echo "<h4 class=modal-title id=titrePopUp>As-tu réfléchi ?</h4>";
        }
        else{
          echo "<h4 class=modal-title id=titrePopUp>Courage !</h4>";
        }
        ?>
      ...
      <div class="modal-body">
        <p class="lead">Score :
          <?=$_SESSION['bonne_rep']?>/<?=$_SESSION['nb_questions']?>
          bip
        </p>
